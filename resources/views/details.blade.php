      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__addtolinks">
            ...
            <a href="javascript:void(0)" class="menu-link menu-link_us-s remove-from-wishlist filled-heart"><svg width="16" height="16" viewBox="0 0 20 20"
                ...
                <div class="swiper-slide product-card">
                    ...
                    <a href="{{route('shop.product.details',['product_slug'=>$rproduct->slug])}}" class="pc__img-link">
                        ...
                        @foreach (explode(',', $rproduct->images) as $gimg)
                            <img loading="lazy" src="{{asset('uploads/products/thumbnails')}}/{{$gimg}}" width="330" height="400" alt="{{$rproduct->name}}" class="pc__img pc__img-second">
                        @endforeach
                    </a>
                    ...
                    @else
                      <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                        ...
                        <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">Add To Cart</button>
                      </form>
                    @endif
                    </div>
                    ...
                    <h6 class="pc__title"><a href="{{route('shop.product.details',['product_slug'=>$rproduct->slug])}}" class="pc__img-link">{{$rproduct->name}}</a></h6>
