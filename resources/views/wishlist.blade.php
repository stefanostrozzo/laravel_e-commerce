      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
                ...
                <td>
                  <div class="row justify-content-center">
                    <div class="col" style="vertical-align: middle;">
                      <form method="POST" action="{{route('wishlist.move', ['rowId' => $item->rowId])}}" id="move-to-cart-{{$item->id}}">
                        @csrf
                    ...
                    <div class="col" style="vertical-align: middle;">
                      <form method="POST" action="{{route('wishlist.remove', ['rowId' => $item->rowId])}}" id="remove-item-{{$item->id}}">
                        @csrf
                        @method('DELETE')
                        <a href="javascript:void(0)" class="remove-cart" onclick="getElementById('remove-item-{{$item->id}}').submit();">
          ...
          <div class="cart-table-footer">
            <form method="POST" action="{{route('wishlist.empty')}}" id="clear-wishlist">
              @csrf
              @method('DELETE')
