              ...
              @foreach ($categories as $category)
                <div class="swiper-slide">
                  ...
                  <div class="text-center">
                    <a href="#" class="menu-link fw-medium">{{$category->gender}}<br/>{{$category->name}}</a>
                  </div>
                </div>
              @endforeach
            </div><!-- /.swiper-wrapper -->
              ...
              <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                ...
                <div class="pc__info position-relative">
                  ...
                  <div class="product-card__price d-flex align-items-center">
                    <span class="money price text-secondary">$ @if($fproduct->sale_price)<s>{{$fproduct->regular_price}}</s> ${{$fproduct->sale_price}} @else {{$fproduct->regular_price}} @endif</span>
                  </div>
                </div>
              </div>
            </div>
