        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST" action="{{route('admin.coupons.update')}}">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Coupon Code" name="code" value="{{$coupon->code}}"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Coupon Value" name="value" value="{{$coupon->value}}"
                        tabindex="0" value="" aria-required="true" required="">
                </fieldset>
                @error('value') <span class="alert alert-danger text-center">{{ $message }}</span> @enderror
                <fieldset class="name">
                    <div class="body-title">Cart Value <span class="tf-color-1">*</span></div>
                    <input class="flex-grow" type="text" placeholder="Cart Value" value="{{$coupon->cart_value}}"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="date" placeholder="Expiry Date" value="{{$coupon->expiry_date}}"
