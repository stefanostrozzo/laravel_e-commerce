      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page size" id="pagesize" style="margin-right: 0px;" name="pagesize">
              <option value="12" {{$size == 12 ? 'selected' : ''}} style="text-align: center;">Show</option>
              <option value="24" {{$size == 24 ? 'selected' : ''}} style="text-align: center;">24</option>
              <option value="48" {{$size == 48 ? 'selected' : ''}} style="text-align: center;">48</option>
              <option value="102" {{$size == 102 ? 'selected' : ''}} style="text-align: center;">102</option>
            </select>

            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="orderby" id="orderby" name="total-number">
              <option value="-1" {{$order == -1 ? 'selected' : ''}} style="text-align: center;">Default</option>
              <option value="1" {{$order == 1 ? 'selected' : ''}} style="text-align: center;">Date, new to old</option>
              <option value="2" {{$order == 2 ? 'selected' : ''}} style="text-align: center;">Date, old to new</option>
              <option value="3" {{$order == 3 ? 'selected' : ''}} style="text-align: center;">Price, low to high</option>
              <option value="4" {{$order == 4 ? 'selected' : ''}} style="text-align: center;">price, high to low</option>
            </select>
                ...
                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                  ...
                  <div class="pc__info position-relative">
                    ...
                    <form method="POST" action="{{route('wishlist.remove', ['rowId'=> Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId])}}">
                      @csrf
                      @method('DELETE')
                      <button style="color: orange;" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist" title="Add To Wishlist">
