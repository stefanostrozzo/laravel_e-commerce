...
Route::middleware(['auth',AuthAdmin::class])->group(function(){
    ...
    Route::get('/admin/categories/add', [AdminController::class, 'categoryAdd'])->name('admin.categories.add');
    Route::post('/admin/categories/add', [AdminController::class, 'categoryStore'])->name('admin.categories.store');
